...
| Task | Owner |
|------|-------|
| Backend / API / data pipeline | backend specialist (@reliable-backend-architect) |
| Frontend / UI / visualization | frontend specialist (@modern-ui-engineer) |
| Tests (creation or expansion) | Test Specialist (@test-automation-engineer) |
| Performance Optimization | Performance Specialist (@app-performance-engineer) |
| Security Audit | Security Specialist (@security-code-reviewer) |
